...
CREATE TABLE public.customer_checks (
  ...
  CONSTRAINT customer_checks_bank_id_fkey FOREIGN KEY (bank_id) REFERENCES public.Banks(Banks_ID),
  CONSTRAINT customer_checks_bank_branch_fkey FOREIGN KEY (bank_branch) REFERENCES public.Branchs(Branch_ID)
);
...
CREATE TABLE public.supplier_checks (
  ...
  CONSTRAINT supplier_checks_bank_id_fkey FOREIGN KEY (bank_id) REFERENCES public.Banks(Banks_ID),
  CONSTRAINT supplier_checks_bank_branch_fkey FOREIGN KEY (bank_branch) REFERENCES public.Branchs(Branch_ID)
);

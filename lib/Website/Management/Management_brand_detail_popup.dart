...
class BrandDetailPopup extends StatefulWidget {
  final int brandId;
  final VoidCallback? onUpdate;
  const BrandDetailPopup({super.key, required this.brandId, this.onUpdate});
  @override
  State<BrandDetailPopup> createState() => _BrandDetailPopupState();
}

class _BrandDetailPopupState extends State<BrandDetailPopup> {
        ...
        if (isLoading)
          ...
          Column(
            ...
            children: [
              ...
              isEditMode
                  ? _EditField(label: 'Brand Name', controller: nameController)
                  : _DetailRow(
                      label: 'Brand Name',
    ...
    builder: (ctx) => BackdropFilter(
      ...
      child: Dialog(
        ...
        child: Padding(
          ...
          child: BrandDetailPopup(brandId: brandId, onUpdate: onUpdate),
        ),
      ),
    ),
  );

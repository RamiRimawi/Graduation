...
class _AddOutgoingCheckPageState extends State<AddOutgoingCheckPage> {
        ...
        children: [
          ...
          Positioned(
            child: CompositedTransformFollower(
              ...
              offset: const Offset(0, 60), // Position below the field
              child: Material(
                elevation: 4,
  ...
  Future<String> _uploadCheckImage() async {
    final fileName = 'outgoing_${DateTime.now().millisecondsSinceEpoch}.png';
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      await Supabase.instance.client.from('supplier_checks').insert({

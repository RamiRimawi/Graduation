...
class PreparingOrderDetailsPage extends StatefulWidget {
  final int orderId;

  const PreparingOrderDetailsPage({super.key, required this.orderId});

  @override
  State<PreparingOrderDetailsPage> createState() =>
      _PreparingOrderDetailsPageState();
}

class _PreparingOrderDetailsPageState extends State<PreparingOrderDetailsPage> {
  bool _loading = true;
  ...
  Future<void> _fetchOrderDetails() async {
    try {
      ...
      debugPrint('Error fetching preparing order: $e');
